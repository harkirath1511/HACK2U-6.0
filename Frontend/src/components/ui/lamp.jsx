  ...
  return (
    (<LampContainer >
      <motion.h1
        ...
        className=" bg-gradient-to-br from-slate-300 to-slate-500 py-4 text-white bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl">
...
export const LampContainer = ({
  ...
  return (
    ...
    <div
      className={cn(
        "relative flex h-[40vh] flex-col items-center my-0 justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}>
      <div
